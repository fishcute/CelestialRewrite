...
public class CelestialSky {
    ...
    public static void loadResources() {
        ...
        if (VMinecraftInstance.doesPlayerExist())
            VMinecraftInstance.sendInfoMessage("[Celestial] Reloaded with " + warnings + " warning(s) and " +errors + " error(s).");
    }
    ...
    static class Variable {
        ...
        public Variable(String value, int updateFrequency) {
            this.value = Util.compileExpression(value);
            this.updateFrequency = updateFrequency;
            this.updateTick = updateFrequency;
        }

        public void updateValue() {
            this.storedValue = this.value.invoke().floatValue();
        }
    }
}
